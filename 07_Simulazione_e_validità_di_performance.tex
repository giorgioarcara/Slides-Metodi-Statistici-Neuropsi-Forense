...
\begin{frame}
% TITLE SLIDES
\title{Metodi Statistici per la Neuropsicologia Forense\\ \vspace{1em} \emph{7. Simulazione e validità di performance}}
...
\section{\texorpdfstring{\large 7. Simulazione e validità di
performance}{7. Simulazione e validità di performance}}\label{simulazione-e-validituxe0-di-performance}
...
\begin{frame}{come definire un ``simulatore''? 1/2}
\phantomsection\label{come-definire-un-simulatore-12}
\small
...
\item
  ...
  che è inverosimile che simulino. \pause
\item
...
\begin{frame}{come definire un ``simulatore''? 2/2}
\phantomsection\label{come-definire-un-simulatore-22}
\small

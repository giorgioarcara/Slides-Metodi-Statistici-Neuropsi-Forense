...
\begin{frame}
% TITLE SLIDES
\title{Metodi Statistici per la Neuropsicologia Forense\\ \vspace{1em} \emph{8. Altri utilizzi dei punteggi dei test}}
...
\begin{center}
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{Figures/Figure_true_obs_4.png}
\end{center}
...
L'utilizzo di forme parallele o la lunga distanza tra le due valutazioni
non garantisce una protezione dall'effetto pratica (Mondini e Arcara,
2008)
\end{frame}

...
dipendono da se il criterio è una variabile continua (es. Il punteggio
ad un altro test) oppure una variabile categoriale (es. L'appartenza ad
un gruppo, es MCI vs Controlli).
\end{frame}

...
forense di GH?} \vspace{2em} \pause La maggior parte delle volte lo
scopo di una valutazione neuropsicologica ha come obiettivo valutare la
presenza di un deficit/danno cognitivo.
\end{frame}
...
sia avvenuto un peggioramento, ma che il danno sia anche \emph{causato}
dal fatto esaminato.
\end{frame}

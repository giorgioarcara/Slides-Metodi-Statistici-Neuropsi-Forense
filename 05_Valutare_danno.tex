...
forense di GH?} \pause \vfill La maggior parte delle volte lo scopo di
una valutazione neuropsicologica ha come obiettivo valutare la presenza
di un deficit/danno cognitivo.
\end{frame}
...
suggerire che i disturbi siano insorti dopo il primo trauma cranico, ma
il figlio sostiene che il padre sia peggiorato dopo il recente
incidente.

Nel caso l'interesse sia sul deficit, che però ci interessa \textbf{non}
è quali dei due eventi abbia potuto causare un eventuale deficit o danno
cognitivo, ma \textbf{se ci sono elementi che possono spiegare il suo
comportamento}.

In altre parola, in questo caso l'interesse è capire se la persona ha un
disturbo cognitivo (indipendentemente dalla causa).
\end{frame}
...
Per trasformare il punteggi ad un test cognitivo come qualcosa di
interpretabile e utile spesso avviene una trasformazione rispetto alla
percentuale di popolazione che ottiene quel punteggio.

Tra questi dati spesso rivestono particolare rilevanza delle soglie
specifiche, chiamate \textbf{cut-off}, che sono spesso il 5\% delle
...
per arrivare ad una decisione. Questo test statistico è spesso un test
particolare perché \emph{applicato al caso singolo}.
\end{frame}
...
\begin{frame}{Valutare i deficit/danni cognitivi}
\phantomsection\label{valutare-i-deficitdanni-cognitivi-3}
\begin{center}
  \textbf{I  cut-off e i dati normativi}
\end{center}
...
\begin{frame}{Valutare i deficit/danni cognitivi}
\phantomsection\label{valutare-i-deficitdanni-cognitivi-4}
\begin{center}
...
\begin{frame}{Valutare i danni cognitivi}
\phantomsection\label{valutare-i-danni-cognitivi}
\begin{center}
  \textbf{Il razionale alla base dell’utilizzo dei dati normativi}
\end{center}
...
\begin{frame}{Valutare i deficit/danni cognitivi}
\phantomsection\label{valutare-i-deficitdanni-cognitivi-5}
\begin{center}
  \textbf{Il razionale alla base dell’utilizzo dei dati normativi}
\end{center}
...
\begin{frame}{Normalità nei dati normativi}
\phantomsection\label{normalituxe0-nei-dati-normativi}
\begin{center}
...
\begin{frame}{Deficit o danno?}
\phantomsection\label{deficit-o-danno}
\small

In questo caso l'adeguatezza del confronto può dipendere dal tipo di
domanda: \textbf{classificare la prestazione (cioè stimare un deficit)
oppure stimare un danno}.
...
Si veda per esempio
\href{https://journals.sagepub.com/doi/full/10.1177/09593543231160112}{questo
articolo} per un approfondimento sul valore epistemico di scelte
dicotomiche, che ben si applica a questo caso.
\end{frame}

\begin{frame}{Perché questo modo ``contorto'' di definire il deficit
cognitivo e il danno? 1/3}
\phantomsection\label{perchuxe9-questo-modo-contorto-di-definire-il-deficit-cognitivo-e-il-danno-13}
...
\begin{frame}{Perché questo modo ``contorto'' di definire il deficit
cognitivo e il danno? 2/3}
\phantomsection\label{perchuxe9-questo-modo-contorto-di-definire-il-deficit-cognitivo-e-il-danno-23}
...
In neuropsicologia clinica e forense spesso siamo chiamati valutare due
aspetti:

...
## \small Sensibilità/Specificità sono proprietà del test, non della valutazione 1/3
...
## \small Sensibilità/Specificità sono proprietà del test, non della valutazione 2/3
...
### \small Sensibilità/Specificità sono proprietà del test, non della valutazione 3/3


Strettamente parlando, non avrebbe senso dire questo individuo 90% di Probabilità di avere Alzheimer (se avessimo la possibilità di conoscere la verità: o ce l’ha o non ce l’ha). Occorre sempre trattare correttamente le probabilità restituite dai test. Il test mi dice il 90% di persone con Alzheimer hanno questa prestazione. L’esempio è più semplice se si usano condizioni di interesse come “presenza di tumore” (o c’è oppure no e si può capire con esame istologico, che è la nostra "verità").
...
_AT è un professionista di 60 anni che coordina uno studio di commercialisti. Da circa un anno I colleghi si lamentano di alcuni errori a lavoro. AT si dimentica a volta di appuntamenti importanti o di clienti. Il CdA cerca di togliergli il suo ruolo sostenendo di non avere le capacità cognitive per potere ricoprire questo ruolo, ma AT non vuole cederlo. In questa disputa il CdA richiede una valutazione cognitiva in cui. Il primo consulente di parte somministra il MoCA._
...
_Siete consulenti di parte per AT, un professionista di 55 anni che coordina uno studio di commercialisti. In seguito ad un incidente stradale con trauma cranico, la sua capacità di concentrarsi si riduce drammatiamente e non è più in grado di seguire lo studio. Dopo circa due mesi dall’incidente l’assicurazione manda un perito che somministra il MoCA._
...
La probabilità di simulazione in un contesto di valutare a fini assicurativi, è diverso della probabilità di simulazione in un contesto di valutazione in un centro Valutazione Alzheimer, perchè verosimilmente, cambia la prevalenza della patologia _degli individui testati_.
...
Dove $y$ è il cut-off di discriminazione, $o$ è il punteggio osservato. $C$ è l’appartenenza al gruppo di persone con Condizione di interesse (es. patologia) e $H$ appartenza al gruppo di persone senza condizione di interesse (es. sani)..
...
Probabilità che di fatto non potremo sapere mai (cioè Probabilità a Priori, che è anche associata a Prevalenza, se si far riferimento ai concetti di PPV e PPN).

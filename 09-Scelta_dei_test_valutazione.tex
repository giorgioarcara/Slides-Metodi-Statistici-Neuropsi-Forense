...
\begin{frame}
% TITLE SLIDES
\title{Metodi Statistici per la Neuropsicologia Forense\\ \vspace{1em} \emph{9. La scelta dei test per la valutazione clinica o forense}}
...
\section{La scelta dei test per la valutazione neuropsicologica clinica
e
forense}\label{la-scelta-dei-test-per-la-valutazione-neuropsicologica-clinica-e-forense}
...
\textbf{È l'approccio più diffuso in ambito forense, anche per via dei
tempi limitati della valutazione}
\end{frame}

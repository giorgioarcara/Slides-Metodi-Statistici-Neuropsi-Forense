...
di lunghezza) \pause \vspace{2em} Supponiamo ad un test di memoria una
persona ottiene 40, mentre un'altra 42 Vi sentireste di concludere che
quella persona ha due unità di memoria in più dell'altra? \pause o
semplicemente che ha più memoria?
\end{frame}

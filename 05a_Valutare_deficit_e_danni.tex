...
\begin{frame}{Un caso di valutazione neuropsicologica forense}
\phantomsection\label{un-caso-di-valutazione-neuropsicologica-forense}
...
I test test statistici utilizzati in contesto clinico e forense sono
spesso non convenzionali perché \emph{applicati al caso singolo} (mentre
gran parte della statistica inferenziale stima effetti medi riferiti a
gruppi).
\end{frame}
...
\emph{Qual potrebbe essere in questo caso lo scopo della valutazione

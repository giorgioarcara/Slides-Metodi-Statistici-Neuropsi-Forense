...
\begin{frame}
% TITLE SLIDES
\title{Metodi Statistici per la Neuropsicologia Forense\\ \vspace{1em} \emph{5. Valutare i deficit e danni cognitivi - Formule}}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-1}
\begin{center}
  \textbf{Il cut-off clinico e i valori soglia}
\end{center}
\vspace{1em}
...
applicata alla neuropsicologia clinica e forense.
...
una prestazione insolita, mprobabile, assumendo che si sia normali.
\end{frame}

\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-2}
\begin{center}
  \textbf{Il cut-off clinico e i valori soglia}
\end{center}
\vspace{2em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-3}
\begin{center}
  \textbf{Il cut-off clinico}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-4}
\begin{center}
  \textbf{I valori utili per la clinica}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-5}
\begin{center}
  \textbf{I percentili}
\end{center}
\vspace{2em}
...
L'uso di punti z non è altro che un metodo che semplifica
l'identificazione di questi percentili.
\end{frame}

\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-6}
\begin{center}
  \textbf{I percentili}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-7}
\begin{center}
  \textbf{Trasformazione in punti z}
\end{center}
...
Se i punteggi \textbf{non} sono standardizzati.
...
numero (sempre arbitrario) per delimitare preformance bassa.
\end{frame}

\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-8}
\begin{center}
  \textbf{I percentili}
\end{center}
\vspace{2em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-9}
\begin{center}
  \textbf{La distribuzione di riferimento}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-10}
\begin{center}
  \textbf{Analogia con ipotesi nulla in test statistico}
\end{center}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-11}
\begin{center}
  \textbf{Esperimento mentale}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-12}
\begin{center}
  \textbf{Campione o popolazione}
\end{center}
\vspace{2em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-13}
\begin{center}
  \textbf{Campione o popolazione}
\end{center}
\vspace{2em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-14}
\begin{center}
  \textbf{Percentile o probabilità?}
\end{center}
\vspace{2em}
...
Avere una ercentuale non significa necessariamente che sto controllando la probabilità di errore, usare percentili o z-scores si approssima a probabilità (in termini di popolazione) solo quando I campioni sono grandi e sono rispettati assunti (Es. Normalità distribuzione della popolazione).
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-15}
\begin{center}
  \textbf{Campione o popolazione}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-16}
\begin{center}
  \textbf{Campione o popolazione}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-17}
\begin{center}
  \textbf{Confronti con valori soglia e statistica inferenziale}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-18}
\begin{center}
  \textbf{Confronti con valori soglia e statistica inferenziale}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-19}
\begin{center}
  \textbf{Confronti con valori soglia e statistica inferenziale}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-20}
\begin{center}
  \textbf{Confronti con valori soglia e statistica inferenziale}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-21}
\begin{center}
  \textbf{Nota confortante}
\end{center}
\vspace{2em}
...
(Questa è una considerazione da prendere \emph{cum granu salis}, a
partire da simulazioni dello script 10 associato a queste slides)
\end{frame}

\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-22}
\begin{center}
  \textbf{t-test di Crawford e Howell}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-23}
\begin{center}
\textbf{t-test di Crawford}
\end{center}
\vspace{1em}

\[
t = \frac{X_1 - X_2}{s_2\sqrt{\frac{N_2+1}{N_2}}}
\]

\vspace{1em}

Confrontando con distribuzione con \(N_2-1\) gradi di libertà il
risultato da la probabilità (data ipotesi nulla vera) di ottenere valori
di \(t\) uguali o inferiori (vedi codice di esempio)
\end{frame}

\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-24}
\begin{center}
\textbf{Confronto con i dati normativi}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-25}
\begin{center}
\textbf{Note su t-test di crawford (1/2)}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-26}
\begin{center}
\textbf{Note su t-test di crawford (2/2)}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-27}
\begin{center}
\textbf{Confronto con i dati normativi}
\end{center}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-28}
\begin{center}
\textbf{Confronto con i dati normativi}
\end{center}
...
Es. se il mio paziente ha 68 anni e 5 anni di scolarità (come GH), quale
è un gruppo adeguato?
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-29}
\begin{center}
\textbf{Appropriatezza del campione di riferimento}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-30}
\begin{center}
\textbf{Metodi di regressione}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-31}
\begin{center}
\textbf{Metodi di regressione}
\end{center}
\vspace{1em}
...
\[
x : P(oi< x∣ V 1i , V 2i , ... , Vni , N )=k
\]

Classicamente i modelli di regressione includono età, scolarità e sesso
come variabili predittori della performance
\end{frame}

\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-32}
\begin{center}
\textbf{Metodi di regressione: variabili da considerare}
\end{center}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-33}
\begin{center}
\textbf{Metodi di regressione: variabili da considerare}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-34}
\begin{center}
\textbf{Metodi di regressione}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-35}
\begin{center}
\textbf{I Punteggi Equivalenti}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-36}
\begin{center}
\textbf{I Punteggi Equivalenti}
\end{center}
\vspace{2em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-37}
\begin{center}
\textbf{I Punteggi Equivalenti}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-38}
\begin{center}
\textbf{I Punteggi Equivalenti}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-39}
\begin{center}
\textbf{I Punteggi Equivalenti}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-40}
\begin{center}
\textbf{I Punteggi Equivalenti}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-41}
\begin{center}
\textbf{I Punteggi Equivalenti}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-42}
\begin{center}
\textbf{I Punteggi Equivalenti}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-43}
\begin{center}
\textbf{I Punteggi Equivalenti}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-44}
\begin{center}
\textbf{I Punteggi Equivalenti}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-45}
\begin{center}
\textbf{I Punteggi Equivalenti}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-46}
\begin{center}
\textbf{I Punteggi Equivalenti}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-47}
\begin{center}
\textbf{Esempio di Punteggi Equivalenti}
\end{center}
\vspace{2em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-48}
\begin{center}
\textbf{Considerazioni su metodi di regressione}
\end{center}
\vspace{2em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-49}
\begin{center}
\textbf{Considerazioni su metodi di regressione}
\end{center}
\vspace{2em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-50}
\begin{center}
\textbf{Limiti dei metodi di regressione (1/2)}
\end{center}
\vspace{2em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-51}
\begin{center}
\textbf{Limiti dei metodi di regressione (1/2)}
\end{center}
\vspace{2em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-52}
\begin{center}
\textbf{Considerazioni su errore di I e II tipo}
\end{center}
\vspace{2em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-53}
\begin{center}
\textbf{Considerazioni su errore di I e II tipo}
\end{center}
\vspace{2em}
...
Per calcolare quindi errore di primo tipo, si studiano in genere diversi possibili scenari \textbf{ipotetici}.
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-54}
\begin{center}
\textbf{Considerazioni su errore di I e II tipo}
\end{center}
\vspace{2em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-55}
\begin{center}
\textbf{Riassunto finale (1/2)}
\end{center}
\vspace{2em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-56}
\begin{center}
\textbf{Riassunto finale (1/2)}
\end{center}
\vspace{1em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-57}
\begin{center}
\textbf{Riassunto finale (2/2)}
\end{center}
\vspace{2em}
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-58}
\begin{center}
\textbf{Torniamo al nostro esempio (slide 2 blocco 5. Valutare i deficit e danni cognitivi)}
\end{center}
\end{frame}

\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-59}
\small
...
\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-60}
\begin{center}
\textbf{Torniamo al nostro esempio}
\end{center}
\vspace{1em}

Supponiamo di usare il test Linguaggio Figurato 1 di APACS (comprovate
Validità e Affidabilità e che misuri capacità di valutare Linguaggio
Figurato).

Per questo test abbiamo una consistenza interna sufficiente (0.65), una
buona affidabilità test-retest ad un mese r = 0.94 e basso effetto
pratica.

C'è qualche evidenza di validità di costrutto, da analisi fattoriale e
una buona validità contenuto a partire da valutazione di alcuni esperti.
\end{frame}

\begin{frame}{Valutare i deficit e danni cognitivi}
\phantomsection\label{valutare-i-deficit-e-danni-cognitivi-61}
\begin{center}
\textbf{Torniamo al nostro esempio}
\end{center}
\vspace{1em}

Il cut-off per una persona con 68 anni di età e 5 di scolarità è 12.
Considerando che il metodo usato da APACS per i cut-offs considera la
distinizone tra campione e popolazione questo significa che un punteggio
al di sotto del cut-off è atteso da meno del 5\% della popolazione (di
sani).

Se GH ottenesse meno 12 potremmo concludere che è una prestazione
insolita se fosse sano, ma non possiamo dire se è un deficit
pre-esistente, o un danno legato al trauma cranico (I metodi per
calcolare deficit o danno, sono analoghi).

Andando a vedere le tabelle di APACS, possiamo vedere che però nel
gruppo di sani usati, sono 40 rientrano nel gruppo di età e scolarità di
GH. Le stime sono quindi abbastanza solide.
\end{frame}

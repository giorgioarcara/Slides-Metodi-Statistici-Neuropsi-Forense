...
-   Lezioni online principalmente il mercoledì e il giovedì (dalle 9.00 alle 11.30 circa). 1 pausa in mezzo.
-   Le lezioni saranno videoregistrate e rese disponibile sul moodle.
-   Le lezioni prevedono didattica frontale (interattiva) ed esercitazioni in classe.
...
![](Figures/Valutazione_Neuropsi_ChatGPT.png){width="50%" fig-align="center"}
\pause

**Valutazione neuropsicologica**: esame clinico per indagare il funzionamento cognitivo a fine descrittivo o diagnostico. In genere sono somministrati una serie di _test neuropsicologici_ ad un individuo per indagare il suo funzionamento cognitivo.

Sono ottenuti punteggi e questi sono confrontati con valori di riferimento per trarre conclusioni (es. è presente un deficit cognitivo.)

## Neuropsicologia Forense

Dietro la semplicità di quanto descritto ci sono tanti aspetti metodologici (psicometrici e statistici) che saranno approfonditi in questo corso.
...
## Focus sui test statistici per caso singolo

Il più delle volte in ambito forense, l'interesse è dare delle risposte su un singolo individuo.

Da un punto di vista statistico questo significa utilizzare metodi che permettono di rispondere non a campioni, ma a singoli individui (ed è qualcosa di particolarmente rilevante)
...
Conoscere quando queste avvengono porta ad una maggiore controllo di ciò
...
Sottolineare interpretazioni non significa che ogni interpretazione va bene. Le interpretazioni maggiormente supportate da evidenze (test, aspetti qualitativi, anamnesi, etc.) sono migliori di quelle che non sono supportate. 

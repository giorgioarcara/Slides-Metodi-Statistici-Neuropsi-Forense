...
risultati legati ad un criterio esterno. Quest criterio è spesso
...
etc.) o il punteggio ad un altro test.
...
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{Figures/APACS_reliability.png}
\end{frame}
...
perfetto. Che effetti ha su validità ed affidabilità?
...
\begin{frame}{Considerazioni conclusive 1/3}
\phantomsection\label{considerazioni-conclusive-13}
...
\begin{frame}{Considerazioni conclusive 2/3}
\phantomsection\label{considerazioni-conclusive-23}
Queste due qualità non ci dicono però necessariamente, l'\textbf{utilità
clinica/forense} del test **per una specifica valutazione*04a0.
...
\begin{frame}{Considerazioni conclusive 3/3}
\phantomsection\label{considerazioni-conclusive-33}
...
di questa corso) si focalizza proprio sull'identificare la validità
